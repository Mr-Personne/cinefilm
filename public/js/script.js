...
function ajaxCallAsynch() {
    ...
    if (inputSearch.value.length === 0) {
        ...
        fetch('model/search-bar.php', paramAjax).then(function (response) {
            ...
            var html = "<div class='container-fluid'><div class='row'><div class='col'>";
            var resultDiv = document.querySelector('#search-result');
            ...
            resultDiv.innerHTML = html+"</div></div></div>";
